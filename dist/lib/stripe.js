...
export const stripeServices = {
    ...
    createCheckoutSession: async (paymentId, amount, metadata) => {
        const { rentalRequestId, tenantId, propertyId, propertyTitle, description, customerEmail, } = metadata;
    ...
    constructWebhookEvent: (payload, signature) => {
        ...
        if (!webhookSecret) {
            ...
            throw new Error("STRIPE_WEBHOOK_SECRET is not configured. Please add it to .env file.");
        }
