...
const getLandlordRentalRequests = catchAsync(async (req, res) => {
    ...
    const result = await rentalServices.getLandlordRentalRequests(landlordId, query);
    sendResponse(res, {
        success: true,
        statusCode: httpStatus.OK,
...
const getSingleRentalRequest = catchAsync(async (req, res) => {
    ...
    const result = await rentalServices.getSingleRentalRequest(id, userId, userRole);
    sendResponse(res, {
        success: true,
        statusCode: httpStatus.OK,
...
const updateRentalStatus = catchAsync(async (req, res) => {
    ...
    const result = await rentalServices.updateRentalStatus(id, landlordId, payload);
    sendResponse(res, {
        success: true,
        statusCode: httpStatus.OK,
        message: result.message,
...
const cancelRentalRequest = catchAsync(async (req, res) => {
    ...
    const result = await rentalServices.cancelRentalRequest(id, tenantId);
    sendResponse(res, {
        success: true,
        statusCode: httpStatus.OK,
        message: result.message,
...
// =============================================
const getRentalStats = catchAsync(async (req, res) => {
    const userId = req.user?.id;
    const userRole = req.user?.role;
    if (!userId) {
        return sendResponse(res, {
    ...
    const result = await rentalServices.getRentalStats(userId, userRole);
    sendResponse(res, {
        success: true,
        statusCode: httpStatus.OK,
